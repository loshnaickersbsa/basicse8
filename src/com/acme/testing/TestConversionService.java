...
//		 can you figure out why these do not compile
		...
		short grams = ConversionService.grams(30).shortValue();
		byte byteGrams = ConversionService.grams(30).byteValue();
		...
		char z = 'z';
		float x = 21L; //upcasting
	//	z=5;
		System.out.println(" z is : "+ ((int) z)+ " : conversion" +  ConversionService.milliliters(z));
